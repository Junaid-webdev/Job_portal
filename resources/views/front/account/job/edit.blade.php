...
@section('customJs')
 ...
 // Ab mujhe Createform kai jagah name change karna hai or is ajax code ko chlana hai ye kaam gher pr karna ahi //
 // abhi mujhe promise padhana hai //
...
$('#editJobForm').submit(function(e){
     ...
     if(response.status == false){
         var errors = response.errors;
           if(errors.title){
                ...
                if(errors.category){
                    $('#category').addClass('is-invalid').siblings('p').html(errors.category[0]);
                }
                if(errors.jobtype){
                    $('#jobtype').addClass('is-invalid').siblings('p').html(errors.jobtype[0]);
                }
                if(errors.vacancy){
                    $('#vacancy').addClass('is-invalid').siblings('p').html(errors.vacancy[0]);
                }
                if(errors.location){
                    $('#location').addClass('is-invalid').siblings('p').html(errors.location[0]);
                }
                if(errors.description){
                    $('#description').addClass('is-invalid').siblings('p').html(errors.description[0]);
                }
                if(errors.company_name){
                    $('#company_name').addClass('is-invalid').siblings('p').html(errors.company_name[0]);
                }
            }else{
    ...
    $('#createJobForm').on('input change', 'input, select, textarea', function() {
