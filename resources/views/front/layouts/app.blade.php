  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ProfilePic" name="ProfilePic" action="" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© 2025 Amazone company, all right reserved</p>
</div>
</footer> 
...
$("#ProfilePic").submit(function(e){
    ...
    $.ajax({
        url: '{{ route("account.update-picture") }}',
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
